...
DROP POLICY IF EXISTS "Enable read access for repairs" ON repairs;
DROP POLICY IF EXISTS "Enable insert access for repairs" ON repairs;
DROP POLICY IF EXISTS "Enable update access for repairs" ON repairs;
