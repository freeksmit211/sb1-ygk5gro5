...
import { ArrowLeft, Wind, Zap, Calendar, ListTodo } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';
import MaintenanceSchedules from '../components/sts/MaintenanceSchedules';

const EarthLeakage: React.FC = () => {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900">Earth Leakage Schedule</h2>
        </div>
        <MaintenanceSchedules initialType="earth" />
      </div>
    </div>
  );
};

export default EarthLeakage;