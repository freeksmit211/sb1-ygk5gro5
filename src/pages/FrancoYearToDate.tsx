...
const FrancoYearToDate: React.FC = () => {
  ...
  const getCurrentMonthFuelUsage = () => {
    ...
    fuelEntries.forEach(entry => {
      ...
      if (
        ...
        entry.driver.toLowerCase() === 'franco'
      ) {
        liters += entry.liters;
  ...
  return (
    <div className="min-h-screen bg-blue-600 p-4 md:p-6 space-y-6">
      ...
      <YearToDateFuelUsage entries={fuelEntries} repId="franco" />
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <TodoBoard repId="franco" />
      </div>
    </div>
  );
};

export default FrancoYearToDate;