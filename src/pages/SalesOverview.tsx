...
const SalesOverview: React.FC = () => {
  ...
  const monthData = repData.monthlyData[currentMonth] || {
    target: 0,
    invoiceValue: 0,
    orderValue: 0
  };
  ...
  // Create a modified budget object with only this rep's data
  const repBudget = {
    year: budget.year,
    accounts: {
      [repId]: repData
    ...
    <div className="min-h-screen bg-blue-600 p-4 md:p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-white">{repName}'s Overview</h1>
      ...
      <LastThreeMonthsPerformance budget={repBudget} />
