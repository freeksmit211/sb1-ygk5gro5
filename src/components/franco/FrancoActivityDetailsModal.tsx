...
import { addFeedback, getFeedbackForActivity } from '../../services/francoFeedbackService';

interface FrancoActivityDetailsModalProps {
  isOpen: boolean;
  onClose: () => void;
  activity: FrancoActivity;
}

const FrancoActivityDetailsModal: React.FC<FrancoActivityDetailsModalProps> = ({
  isOpen,
  onClose,
  activity
}) => {
  const [feedback, setFeedback] = useState<FrancoFeedback | null>(null);
...
export default FrancoActivityDetailsModal;