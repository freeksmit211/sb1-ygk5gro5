...
import { JeckieFeedback } from '../../types/jeckieFeedback';
import { addFeedback, getFeedbackForActivity } from '../../services/jeckieFeedbackService';

interface JeckieActivityDetailsModalProps {
  isOpen: boolean;
  onClose: () => void;
  activity: JeckieActivity;
  onFeedbackAdded: () => void;
}

const JeckieActivityDetailsModal: React.FC<JeckieActivityDetailsModalProps> = ({
  isOpen,
  onClose,
  activity,
  onFeedbackAdded
}) => {
  const [feedback, setFeedback] = useState<JeckieFeedback | null>(null);
...
export default JeckieActivityDetailsModal;