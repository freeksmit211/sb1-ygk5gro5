...
import { addVehicle } from '../../services/sheqService';
...
const AddVehicleModal: React.FC<AddVehicleModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!permitFile || !permitExpiry) {
      setError('Permit file and expiry date are required');
      return;
    }
    ...
    try {
      ...
      setError(null);
      await addVehicle(companyId, formData, permitFile, permitExpiry);
      onVehicleAdded();
      onClose();
    } catch (error) {
